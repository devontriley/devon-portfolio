...
const Header = ({ routes }) => {
    return (
        <>
            ...
            <nav id="primaryNav" className="absolute z-30 bottom-5 left-1/2 -translate-x-1/2 border-solid border border-black rounded-full py-3 px-4 md:px-7 bg-white drop-shadow-md">
